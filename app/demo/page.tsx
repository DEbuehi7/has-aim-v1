    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: "16px", fontWeight: 900, color: "#FAFAFA" }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#FF006E", fontWeight: 700, marginBottom: "2px" }}>{DEMO_USER.tier} Member</div>
      ...
      <div style={{ display: "flex", minHeight: "calc(100vh - 120px)" }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: "10px", color: "#71717A", letterSpacing: "0.15em", marginBottom: "16px" }}>
            SELECT COMPANION
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {COMPANIONS.map(c => (
              <div
                key={c.id}
                onClick={() => { setSelected(c); setChat([]); }}
                style={{
                  background: selected?.id === c.id ? "#1A1A2E" : "#0D0D0F",
                  border: selected?.id === c.id ? `1px solid ${c.color}` : "1px solid #1A1A2E",
                  borderRadius: "8px",
                  padding: "16px",
                  cursor: "pointer",
                }}
              >
                ...
                <div style={{ fontSize: "11px", color: "#71717A", marginBottom: "8px", lineHeight: 1.6 }}>
                  {c.personality}
                </div>
                <div style={{
                  fontSize: "11px",
          ...
          {!selected ? (
            ...
            <>
              ...
              <div style={{
                ...
                <div style={{ marginLeft: "auto", fontSize: "9px", color: "#10B981" }}>
                  ONLINE
                </div>
              </div>
              ...
              <div style={{
                ...
                {chat.map((m, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{
                      background: m.role === "user" ? "#FF006E20" : "#0D0D0F",
                      border: m.role === "user" ? "1px solid #FF006E40" : `1px solid ${selected.color}20`,
                      borderRadius: "8px",
                      padding: "12px 16px",
                      fontSize: "13px",
                      color: "#E8E8F0",
